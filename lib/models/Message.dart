...
class Message extends amplify_core.Model {
  ...
  const Message._internal({required this.id, required userId, required username, required message, required room_id, required type, required createdAt, updatedAt}): _userId = userId, _username = username, _message = message, _room_id = room_id, _type = type, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Message({String? id, required String userId, required String username, required String message, required String room_id, required String type, required String createdAt}) {
  ...
  Message copyWith({String? userId, String? username, String? message, String? room_id, String? type, String? createdAt}) {
    return Message._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'userId': _userId, 'username': _username, 'message': _message, 'room_id': _room_id, 'type': _type, 'createdAt': _createdAt, 'updatedAt': _updatedAt?.format()
  };
